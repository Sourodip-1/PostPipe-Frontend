    ...
    return (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none px-4">
            <div className="max-w-4xl w-full text-center space-y-8">
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-headline font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40 tracking-tighter leading-tight">
                    PostPipe is moving to Next.Js
                </h1>
                ...
                <div className="pt-8 pointer-events-auto flex justify-center items-center space-x-4">
                    <div className="group relative inline-flex items-center gap-2 px-4 py-2 bg-white text-black rounded-full font-bold tracking-wide">
                        <Image src="/PostPipe-Black.svg" alt="PostPipe Logo" width={24} height={24} className="relative z-10" />
                        <span className="relative z-10">PostPipe</span>
                    </div>
                    <a href="https://github.com/sourodip-1/PostPipe-2.0" target="_blank" rel="noopener noreferrer" className="group relative inline-flex items-center gap-3 px-6 py-3 bg-white text-black rounded-full font-bold tracking-wide overflow-hidden transition-transform hover:scale-105 active:scale-95">
                        <Github className="relative z-10"/>
                        <span className="relative z-10">github.com/sourodip-1/PostPipe-2.0</span>
                    </a>
                </div>
            </div>
        </div>
